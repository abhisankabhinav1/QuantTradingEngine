...
fig,ax=plt.subplots(2,1,sharex=True); ax[0].plot(df['equity']); ax[0].set_title('Experimental equity curve'); ax[1].plot(df['drawdown']); ax[1].set_title('Drawdown'); fig.tight_layout(); fig.savefig(out/'equity_drawdown.png',dpi=150)
print(df.describe())
